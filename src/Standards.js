...
return (
        <div>
            {JSON.stringify(weightClassName)}
            <div>
                <strong>Official Records & Standards for {weightClassName} {ageGroupName}:</strong>
                {!!relevantRecords && (
                    <div>
                        <div className='record-viewer-standard-set'>
                            ...
                            <div className='record-viewer-standard'>
                                <h3>Clean & Jerk</h3>
                                {renderIndividualStandard(relevantRecords.records["Clean & Jerk"])}
                            </div>
                        </div>
                        <p>
